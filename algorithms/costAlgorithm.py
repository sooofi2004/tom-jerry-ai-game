...
class CostAlgorithm:
    ...
    def start(self):
        ...
        while self.stack:
            ...
            currentNode = self.getNodeMinCost(self.stack)
            ...
            for move, newPos in possible_moves:
                ...
                if 0 <= newPos[0] < self.length_world and 0 <= newPos[1] < self.height_world:
                    ...
                    if currentNode.getState()[newPos[0], newPos[1]] != 1:
                        ...
                        if not any(node.getTomPos() == son.getTomPos() for node in self.stack) and son.avoidGoBack2(newPos):
